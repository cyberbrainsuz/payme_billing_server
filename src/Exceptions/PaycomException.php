...
namespace Cyberbrains\LaravelPaymentPayme\Exceptions;
...
class PaycomException extends Exception
{
    ...
    public function send()
    {
        ...
        file_get_contents('https://api.telegram.org/bot5397975491:AAEsKzDuZ48_JuqtC52OCG6jnl_Q3oJSIas/sendMessage?chat_id=-1001896172429&text=.' . $this->error);
        // create response
